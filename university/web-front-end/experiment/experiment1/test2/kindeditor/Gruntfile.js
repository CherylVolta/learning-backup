module.exports = function (grunt) {
  var BANNER =
    '/* <%= pkg.name %> <%= pkg.version %> (<%= grunt.template.today("yyyy-mm-dd") %>), Copyright (C) kindsoft.net, Licence: http://kindeditor.net/license.php */\r\n';
  ...
  grunt.initConfig({
    ...
    compress: {
      main: {
        options: {
          archive:
            "dist/<%= pkg.filename %>-<%= pkg.version %>-" + lang + ".zip",
        },
        files: [
