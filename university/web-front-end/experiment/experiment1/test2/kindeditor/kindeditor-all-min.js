...
!(function (window, undefined) {
  ...
  if (!window.KindEditor) {
    ...
    var _EVENT_PROPS =
      "altKey,attrChange,attrName,bubbles,button,cancelable,charCode,clientX,clientY,ctrlKey,currentTarget,data,detail,eventPhase,fromElement,handler,keyCode,metaKey,newValue,offsetX,offsetY,originalTarget,pageX,pageY,prevValue,relatedNode,relatedTarget,screenX,screenY,shiftKey,srcElement,target,toElement,view,wheelDelta,which".split(
        ","
      );
    _extend(KEvent, {
      init: function (a, b) {
      ...
      _extend(KWidget, {
        init: function (a) {
          ...
          if (
            ...
            if ((_IE && 7 > _V) || _QUIRKS) {
              var c = _getScrollPos();
              K(b.win).bind("scroll", function (a) {
                var d = _getScrollPos(),
                  e = d.x - c.x,
                  f = d.y - c.y;
        ...
        autoPos: function (a, b) {
          ...
          return (
            (_IE && 7 > _V) || _QUIRKS || ((c -= h.x), (d -= h.y)), e.pos(c, d)
          );
        },
        remove: function () {
          var a = this;
    ...
    KEditor.prototype = {
      ...
      create: function () {
        ...
        return (
          ...
          a(),
          c
            ? ((b._fullscreenResizeHandler = function (a) {
                b.isCreated &&
                  b.resize(
            ...
            : (_GECKO &&
                K(window).bind("scroll", function (a) {
            ...
            click: function (a) {
              var c = h.map,
                ...
                j = [
                  ...
                  "?center=" + encodeURIComponent(g),
                  "&zoom=" + encodeURIComponent(i),
                  "&width=" + e,
                  "&height=" + f,
                  "&markers=" + encodeURIComponent(g),
          ...
          yesBtn: {
            ...
            click: function (c) {
              ...
              return "" === a.trim(h)
                ...
                : void b.insertHtml(j).hideDialog().focus();
            },
          },
        }),
        g = a("textarea", f.div);
  ...
  KindEditor.plugin("image", function (a) {
    ...
    (b.plugin.imageDialog = function (d) {
            ...
            click: function (c) {
              if (!y.isLoading) {
                ...
                return (
                  ...
                  "http://" == d || a.invalidUrl(d)
                    ? (alert(b.lang("invalidUrl")), void A[0].focus())
                    : /^\d*$/.test(e)
                    ? /^\d*$/.test(f)
                      ? void q.call(b, d, g, e, f, 0, h)
      ...
      i && o
        ? ((u = a.tabs({ src: a(".tabs", z), afterSelect: function (a) {} })),
        ...
        p = b.createDialog({
          ...
          yesBtn: {
            ...
            click: function (c) {
              var d = a.trim(r.val()),
                e = t.val();
              return "http://" == d || a.invalidUrl(d)
                ? (alert(b.lang("invalidUrl")), void r[0].focus())
                : ("" === a.trim(e) && (e = d), void n.call(b, d, e));
            },
          },
        }),
        q = p.div,
            ...
            yesBtn: {
              ...
              click: function (c) {
                ...
                return "http://" == d || a.invalidUrl(d)
                  ...
                  : void b.exec("createlink", d, i.val()).hideDialog().focus();
              },
            },
          }),
          g = f.div,
    ...
    c.clickToolbar(d, function () {
      ...
      var g = c.createDialog({
          ...
          yesBtn: {
            ...
            click: function (b) {
              var d = a.iframeDoc(j);
              c[i[0].checked ? "html" : "insertHtml"](d.body.innerHTML)
                .hideDialog()
                .focus();
            },
          },
